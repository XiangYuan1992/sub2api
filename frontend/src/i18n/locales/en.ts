export default {
  ...
  docs: {
    title: 'Documentation',
    subtitle: 'Use one API key with Codex, Claude Code, OpenClaw and Hermes Agent.',
    ...
    quickStart: {
      title: 'Quick Start',
      step1: 'Sign up, log in, and create an API key (starts with sk-) in the dashboard.',
      step2: 'Follow the tool-specific guides below to set the base URL and key.',
      step3: 'Keep your balance topped up. All tools share the base URL shown below.'
    },
    claude: {
      desc: 'Claude Code is the command-line AI coding assistant from Anthropic.',
      skipLogin: 'Skip login',
      skipLoginText: 'Edit or create ~/.claude.json and set hasCompletedOnboarding to true to skip the official login.',
      configText: 'Create ~/.claude/settings.json and replace YOUR_API_KEY with your own key.',
      verifyText: 'Open a new terminal and run the command below; a normal response means success. You can also run /status in Claude Code to verify the base URL.'
    },
    codex: {
      desc: 'Codex is the terminal AI coding assistant from OpenAI.',
      configText: 'Edit ~/.codex/config.toml and put YOUR_API_KEY in the OPENAI_API_KEY environment variable.',
      envHeading: 'Set environment variable',
      envText: 'Set OPENAI_API_KEY to your key (macOS/Linux example; use setx on Windows).',
      verifyText: 'Open a new terminal and run the command below; entering the chat UI means success.'
    },
    openclaw: {
      desc: 'OpenClaw is an open-source personal AI assistant platform. Requires Node.js 22 or later.',
      installText: 'Install globally via npm (or use the official install script).',
      configText: 'Edit ~/.openclaw/openclaw.json and replace YOUR_API_KEY with your key. The example disables gateway auth and is for local single-machine use only.',
      verifyText: 'Restart the gateway to apply, then check with openclaw status.'
    },
    hermes: {
      desc: 'Hermes Agent is a terminal AI coding tool configured via the hermes config set command.',
      configText: 'Run the commands below, replacing YOUR_API_KEY with your key (written to ~/.hermes/config.yaml).',
      verifyText: 'Send a test message with the command below; a normal reply means success.'
    },
    faq: {
      title: 'FAQ',
      q1: 'Which models are supported?',
      a1: 'Claude, GPT, Gemini and other mainstream models — see the available groups on the pricing page.',
      q2: 'Getting a 401 / auth error?',
      a2: 'Check that the API key is copied fully without spaces and not expired, and that the base URL is correct.',
      q3: 'What if my key is leaked?',
      a3: 'Delete the key in the dashboard and generate a new one; the old key is revoked immediately.'
    }
  },
  // Home Page
  home: {
    ...
    navHome: 'Home',
    landing: {
      eyebrow: 'The Universal AI Gateway',
      heroTitle1: 'Connect to the World’s',
      heroTitle2: 'Top AI Models',
      heroDesc: 'Built for global developers and teams — fast direct lines, no ban risk, balance never expires. Alipay / WeChat Pay supported, low-latency access to Claude, ChatGPT, Gemini and more.',
      ctaConsole: 'Go to Console',
      ctaPricing: 'View Pricing',
      ctaDocs: 'Docs',
      ecosystem: 'Ecosystem',
      clientsTitle: 'Supported Clients & AI Coding Tools',
      pricingEyebrow: 'Pricing',
      pricingTitle: 'Pay As You Go',
      pricingSubtitle: '1 RMB = 1 USD, native official models at lower rates',
      valueEyebrow: 'Value',
      valueTitle: 'Unleash Your Coding Potential — Let Top AI Write Code for You',
      faqEyebrow: 'FAQ',
      faqTitle: 'Frequently Asked Questions',
      finalTitle: 'Ready to level up your AI apps?',
      finalDesc: 'Join thousands of developers building the future of AI on stable, professional infrastructure.',
      recommended: 'Popular',
      planPaygoName: 'Pay As You Go',
      planPaygoPrice: 'PAYGO',
      planPaygoDesc: 'Never expires',
      planPaygoF1: 'Top up and get equivalent credit',
      planPaygoF2: 'Billed by actual usage',
      planPaygoF3: 'Never expires',
      planPaygoCta: 'Top Up',
      planClaudeName: 'Claude PAYG',
      planClaudePrice: '1:1 (RMB:USD)',
      planClaudeF1: 'No subscription, flexible usage-based billing',
      planClaudeF2: 'Full Claude model lineup',
      planClaudeF3: 'Optimized for Claude Code',
      planGptName: 'ChatGPT PAYG',
      planGptPrice: '1:1 (RMB:USD)',
      planGptF1: 'No subscription, flexible usage-based billing',
      planGptF2: 'Full OpenAI GPT model lineup',
      planGptF3: 'Optimized for Codex',
      planStart: 'Get Started',
      value1Title: 'Global Direct Access',
      value1Desc: 'Stable access from anywhere, minimizing latency and network interruptions.',
      value2Title: 'High Availability',
      value2Desc: 'Distributed architecture with automatic failover keeps you running.',
      value3Title: 'Easy Integration',
      value3Desc: 'Just change the API base URL — no need to rewrite existing logic.',
      value4Title: 'Fully Compatible',
      value4Desc: 'Compatible with official API behavior, preserving common model capabilities.',
      faq1Q: 'How is it different from official?',
      faq1A: 'Native official models, fully compatible API — just swap the base URL. Billed in RMB at lower prices.',
      faq2Q: 'How is billing calculated?',
      faq2A: 'Billed by actual token usage, balance never expires. See details in usage records.',
      faq3Q: 'Which clients are supported?',
      faq3A: 'Codex, Claude Code, OpenClaw, Hermes Agent and more — see the docs.'
    },
    clients: {
      codex: 'OpenAI’s terminal coding agent, great at large refactors, bug fixes and test generation.',
      codexTag: 'OPENAI',
      claude: 'Anthropic’s official CLI with native extended thinking; coding feels like a conversation.',
      claudeTag: 'ANTHROPIC',
      openclaw: 'Open-source local AI assistant that runs on your own machine and acts via chat.',
      openclawTag: 'Open Source · Local',
      hermes: 'Terminal AI coding tool, configured in one command with custom model providers.',
      hermesTag: 'NOUS RESEARCH'
    },
