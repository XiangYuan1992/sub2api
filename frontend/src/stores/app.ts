...
export const useAppStore = defineStore('app', () => {
  ...
  const siteName = ref<string>('壹站')
  const siteLogo = ref<string>('/yizhan-mark.svg')
  ...
  function applySettings(config: PublicSettings): void {
    ...
    siteName.value = config.site_name || '壹站'
    siteLogo.value = config.site_logo || '/yizhan-mark.svg'
